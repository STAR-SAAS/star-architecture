...
| File | Purpose |
|---|---|
| `00_PROJECT_CHARTER.md` | Current purpose, scope, constraints and success criteria |
| `01_DECISION_LOG.md` | Confirmed working agreements and decisions |
| `02_OPEN_QUESTIONS.md` | Unresolved questions that must not be presented as facts |
| `03_RESEARCH_CANON.md` | Researched methods, verified sources and current STAR posture |
| `04_SUPERSEDED_IDEAS.md` | Ideas that were rejected or superseded, with reasons |
| `05_ASSUMPTIONS.md` | Current hypotheses that still require validation |
| `06_STAKEHOLDER_MAP.md` | Full external and internal stakeholder coverage |
...
- **Confirmed:** accepted in the conversation and usable as a working constraint.
- **Candidate:** plausible direction, still requires evidence or validation.
- **Frozen:** formally approved as a stable baseline. Nothing in this v0.1 package is frozen yet.
- **Superseded:** replaced by a newer working view; retained for traceability.
