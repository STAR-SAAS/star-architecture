...
| **Version / status** | v0.2.8 — Controlled pilot active; SAIG PR #14 professional review completed; keep Draft and continue migration Hold; no further repository transfer authorized; not frozen |
...
| Review | 0 | |
| Waiting | 1 | SAIG remains on Hold while PR #14 is revised and identities, admin evidence and access-control decisions remain open |
| Later | 0 | |
| Parked | 0 | |
...
| PORT-002 | STAR AI Governance | AI Governance | Governance | Next | Hold | STAR AI Governance | ⭐ STAR AI Governance | Robin — COO / AI Governance Owner | Revise Draft PR #14 against the completed professional review and close identity, permission and repository-control gaps before any transfer decision | Correct the four review findings, rerun Self-Review, keep PR #14 Draft until the professional reviewer confirms Ready; separately verify usernames, admin settings and access-control decisions | Private authoritative repository has unresolved document-control corrections, identities, permissions, admin-only settings, branch controls and human-review evidence | Eric continuing Write duty; authorized submitters; Team versus direct roles; branch protection/reviewer/bypass requirements | Draft PR #14 head `cb38aea98e9f5e7ac0e7259b9c153acbc9d35635`, professional Review ID `4701570854`, SAIG `main`, Issues #5–#8 and live GitHub evidence | 2026-07-15 14:42 SGT | 2026-07-15 | Current |
...
| DEP-002 | PORT-002 | PORT-001 | SAIG transfer relies on the company Organization governance and migration method established under SWS-001 | Organization and migration method validated through `star-domains` and `star-platform`; SAIG-specific gates remain open | STAR leadership / SAF / SAIG | Close SAIG document, identity, admin, access and control gates before any transfer authorization | SWS migration Report Backs, PR #14, Review ID `4701570854` and SAIG-DEC-019 |
...
| BLK-008 | PORT-002 | Allen and Louis usernames, direct-submitter population, Eric target role, admin-page inventory and branch-control design are incomplete | SAIG transfer cannot be authorized safely | AI Governance Owner / Organization Owners / repository administrator | Resolve PDR-003 through PDR-006 and complete admin-only checks | 2026-07-15 | DSP-002-003, PR #14 and live GitHub verification | Open |
| BLK-009 | PORT-002 | PR #14 has four unresolved professional-review findings: document-control metadata, closed-question traceability, Triage/record-ID compatibility and Owner-role evidence | PR #14 is not Ready for Review and should not merge in its current form | STAR AI Governance | Revise all four records and rerun Self-Review against a new head | 2026-07-15 | PR #14 professional Review ID `4701570854` | Open |
...
| RPT-008 | PORT-002 | 2026-07-15 | SAIG authority reconciliation and migration pre-transfer assessment | Hold | Draft PR #14 corrects stale records; private repository and Issues #5–#8 verified; target conflict absent; identities, admin settings and access-control decisions remain incomplete | Draft PR #14 head `cb38aea98e9f5e7ac0e7259b9c153acbc9d35635`, SAIG `main`, Issues #5–#8 and live repository metadata | Review PR #14 and resolve PDR-003 through PDR-006 plus admin-only checks | BLK-004 and BLK-008 | Four access/control decisions | Independently verified; transfer not authorized |
| RPT-009 | PORT-002 | 2026-07-15 14:42 SGT | PR #14 professional review and control-design preparation | Hold | Review ID `4701570854` confirms core facts but requires four revisions before Ready for Review; migration remains unauthorized | PR #14 review at head `cb38aea98e9f5e7ac0e7259b9c153acbc9d35635` | Revise document-control metadata, traceability, Triage/ID constraint and Owner evidence; rerun Self-Review | BLK-004, BLK-008 and BLK-009 | PDR-003 through PDR-006 remain open | Independently verified from live GitHub review and PR state |
...
| PORT-002 | 2026-07-15 14:42 SGT | Current | PR #14 Draft state and Professional Review ID `4701570854` independently verified; four revisions and migration/access gates remain open | Revise PR #14; do not mark Ready or merge until re-review; separately close identity/admin/control gates |
...
| PF-015 | 2026-07-15 | PR #14's first Draft omitted document-control metadata and reduced current-state traceability, and it did not preserve the `Triage`/record-ID compatibility constraint | Merging the draft unchanged would create stale or incomplete authority records | Keep Draft and require the four professional-review revisions before Ready for Review | Open professional action |
