...
| **Version / status** | v0.2.1 — Controlled pilot active; effectiveness not yet validated; not frozen |
...
| Later | 0 | |
| Parked | 0 | |
| Active blockers | 2 | PORT-002 Organization/access implementation and PORT-003 missing Mission baseline |
| Decision Needed | 1 | Confirm the exact GitHub Organization name and at least two Owner usernames |
...
| PORT-002 | STAR AI Governance | AI Governance | Governance | Next | Review | STAR AI Governance | ⭐ STAR AI Governance | Robin — COO / AI Governance Owner | Record SAIG-DEC-019, then prepare Organization transfer and least-privilege validation | Merge PR #13 through the professional SAIG workflow; confirm Organization name and at least two Owner usernames; prepare transfer checklist | Organization does not yet exist or is not identified; Owner usernames are incomplete; access and human-review gates remain open | Exact Organization name and at least two Owner usernames | PR #13 and SAIG `main` Work Status / Decision Log | 2026-07-14 14:32 SGT | 2026-07-14 | Current |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| RPT-001 | PORT-001 | 2026-07-14 | SWS-001 | Active | Minimum authoritative SWS record set created | `docs/sws/03_WORK_STATUS.md` | Operate pilot and return architecture findings to SAF | None | None | Verified |
...
|---|---|---|---|---|
| PORT-001 | 2026-07-14 | Current | SWS authority, Project Instructions and first loop verified | Continue evidence collection |
