...
|---|---|
| **Document ID** | SWS-001 |
| **Version / status** | v0.3.0 — Pilot operating; bounded consolidation in progress; not frozen |
| **Owner** | STAR leadership |
| **Maintainer** | STAR Architecture maintainers |
| **Last reviewed** | 2026-07-21 (Asia/Singapore) |
| **Review trigger** | Workspace architecture change, pilot finding, source-of-truth failure, context-loading failure, access-boundary change, consolidation finding or freeze proposal |
...
| Area | Status |
|---|---|
| Global Governance | Working Baseline |
| SWS-001 | Pilot |
| STAR Command Center | Pilot |
| Context Package | Pilot |
| Scope Alias Registry | Pilot |
| Layered Memory | Working Baseline |
| Automatic context loading | Not started |
| Direct mode transfer | Candidate |
| Portfolio Ledger | Pilot |
| Future AI capability integration | Candidate |

These labels describe current maturity only. They do not grant policy activation, Gate passage, Product Commitment, Delivery start, Freeze or Merge.

## Current objective

Operate and consolidate the minimum STAR Command Center and STAR Conversation Governance while preserving professional execution and detailed truth in owning Projects, repositories and systems.
...
7. [`PILOT_ALIAS_REGISTRY.md`](PILOT_ALIAS_REGISTRY.md)
8. [`PUBLIC_PRIVATE_REMEDIATION_REGISTER.md`](PUBLIC_PRIVATE_REMEDIATION_REGISTER.md)
9. [`DRAFT_PR2_CONSOLIDATION_READINESS_CHECKLIST.md`](DRAFT_PR2_CONSOLIDATION_READINESS_CHECKLIST.md)
10. [`DRAFT_PR2_INDEPENDENT_TRACE_REVIEW_CHECKLIST.md`](DRAFT_PR2_INDEPENDENT_TRACE_REVIEW_CHECKLIST.md)

### Conversation governance

11. [`STAR_CONVERSATION_GOVERNANCE.md`](STAR_CONVERSATION_GOVERNANCE.md)
12. [`STAR_CONVERSATION_CONTRACT_TEMPLATE.md`](STAR_CONVERSATION_CONTRACT_TEMPLATE.md)
13. [`STAR_CONVERSATION_ROUTING_MATRIX.md`](STAR_CONVERSATION_ROUTING_MATRIX.md)
14. [`STAR_CHAT_WORK_CODEX_MODE_SELECTION.md`](STAR_CHAT_WORK_CODEX_MODE_SELECTION.md)
15. [`STAR_LAYERED_MEMORY_AND_CONTEXT_LOADING.md`](STAR_LAYERED_MEMORY_AND_CONTEXT_LOADING.md)
16. [`STAR_CONTEXT_PACKAGE_TEMPLATE.md`](STAR_CONTEXT_PACKAGE_TEMPLATE.md)
...
- Alias resolution identifies where to load governed context; it does not determine professional status or truth.

## Current state

- Project Instructions for STAR Command Center have been verified.
- Three pilot workstreams have verified coordination status.
- Real operating loops have been completed.
- Portfolio Ledger is operating within its coordination-only boundary.
- Global Working Rules, Bootstrap Protocol and Self-Review Gate have been used in actual work.
- PDAP is established and operating.
- Context Package has bounded runtime evidence, including M001 resume testing; broader cross-environment validation remains open.
- Scope Alias Registry is entering bounded Pilot with only verified aliases.
- Historical public/private concerns are tracked through a bounded remediation register.
- Project Instructions consistency across every STAR Project remains Missing.
- Independent trace review and final Exact Head readback remain Missing.
- Draft PR #2 remains Open / Draft / Unmerged; Freeze and Merge are not authorized.
